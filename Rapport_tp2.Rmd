...
On choisit comme loi à priori la loi beta avec $\alpha = 2$ et $\beta = 2$. On prend la loi beta puisque son domaine respecte le domaine de notre estimateur, soit $\theta \in [0, 1]$. La figure \ref{fig:beta} permet d'observer la moyenne de la distribution (point rouge) qui est égal à $0.5$. L'équation \ref{EQ:esp beta} permet de confirmer cette valeur. 
\begin{align*}
